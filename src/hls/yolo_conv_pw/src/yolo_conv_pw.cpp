...
WEIGHT_LOOP_OC:
	for(int k = 0; k < fold_output_ch; k++)
	{
...
#pragma HLS PIPELINE
      ...
      local_mem_group[4*k][i].data   = curr_input.data.sub_data_0;
      local_mem_group[4*k+1][i].data = curr_input.data.sub_data_1;
      local_mem_group[4*k+2][i].data = curr_input.data.sub_data_2;
      local_mem_group[4*k+3][i].data = curr_input.data.sub_data_3;
